...
router.get('/', auth, async (req, res) => {
    ...
    try {
        const contacts = await Contact.find({user: req.user.id}).sort({date: -1}) //https://www.mongodb.com/docs/manual/reference/method/cursor.sort/#ascending-descending-sort
        res.json(contacts)
    } catch (err) {
